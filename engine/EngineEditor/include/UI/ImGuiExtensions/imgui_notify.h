...
#include <time.h>
#include <vector>
#include "EngineEditor/include/UI/ImGuiExtensions/font_awesome_5.h"
...
public:
	...
	NOTIFY_INLINE auto get_elapsed_time() { return clock() - this->creation_time; }
